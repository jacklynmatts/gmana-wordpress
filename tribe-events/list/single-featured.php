...
$venue_address = tribe_get_address() . "<br/>" . tribe_get_city() . ", " . tribe_get_state() . " " . tribe_get_zip();
	...
	<div class="author <?php echo esc_attr( $has_venue_address ); ?>">
		...
		<?php if ( $venue_details ) : ?>
			...
			<div class="tribe-events-venue-details">
				<?php 
					echo $venue_details['linked_name'] . "<br/>" . $venue_address;
					//echo implode( '<br/>', $venue_details ); 
				?>
				<?php
